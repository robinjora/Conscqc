...
{
    public partial class rpt585102dx141st3 : System.Web.UI.Page
    {
        ...
        {
            ReportViewer1.LocalReport.ReportPath = "admin\\report\\rpt585102dx141_3.rdlc";
            ...
            //关闭加载提示
            Response.Write("<script type='text/javascript'>top.dclose_rpt585102dx141st3();</script>"); 
        }
