...
{
    public partial class rpt585102dx141 : System.Web.UI.Page
    {
        ...
        {
            ReportViewer1.LocalReport.ReportPath = "admin\\report\\rpt585102dx141.rdlc";
            ...
            //关闭加载提示
            Response.Write("<script type='text/javascript'>top.dclose_rpt585102dx141();</script>"); 
        }
        ...
        private DataTable GetData()
        {
            ...
            DataTable dt = new ZGZY.BLL.Report().rpt585102dx141("sp_webp585102_dx141_new", sparasname, sparas);
            return dt;
        }
