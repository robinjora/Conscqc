...
{
    public partial class cqcp590303 : System.Web.UI.Page
    {
        ...
        {
            //ReportViewer1.LocalReport.ReportPath = "admin\\report\\cqcp590303.rdlc";
            ...
            //关闭加载提示
            Response.Write("<script type='text/javascript'>top.dclose_cqcp590303();</script>");
        }
        ...
        private DataTable GetData()
        {
            ...
            //企业
            str = Request.Form.GetValues("ui_cqcp590303_factidFilter");
            ...
            //日期
            str = Request.Form.GetValues("ui_cqcp590303_begdateFilter");
            ...
            str = Request.Form.GetValues("ui_cqcp590303_enddateFilter");
            ...
            //工程名称
            str = Request.Form.GetValues("ui_cqcp590303_empnameFilter");
            ...
            //强度
            str = Request.Form.GetValues("ui_cqcp590303_strengthFilter");
            ...
            //配比
            str = Request.Form.GetValues("ui_cqcp590303_formulaidFilter");
            ...
            //龄期
            str = Request.Form.GetValues("ui_cqcp590303_daysFilter");
            sparasname[7] = "@indays";
            if (str != null)
            {
                if (str.Length > 0)
            ...
            //日期类型
            str = Request.Form.GetValues("ui_cqcp590303_typeFilter");
            sparasname[8] = "@intype";
            if (str != null)
            {
                sparas[8] = str[0];
            ...
            //报表别
            string scriptname;
            str = Request.Form.GetValues("ui_cqcp590303_rpttypeFilter");
            if (str[0] == "2")
            {
                ReportViewer1.LocalReport.ReportPath = "admin\\report\\cqcp590303_k3.rdlc";
                scriptname = "sp_cqcp590303_k3_web_new";
            }
            else
            {
                ReportViewer1.LocalReport.ReportPath = "admin\\report\\cqcp590303_k2.rdlc";
                scriptname = "sp_cqcp590303_k2_web_new";
            }

            DataTable dt = new ZGZY.BLL.Report().cqcp590303(scriptname, sparasname, sparas);
