<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cqcp590405.aspx.cs" Inherits="ZGZY.WebUI.admin.aspx.cqcp590405" %>
...
<body>
    ...
    <div data-options="region:'center',border:false">
        <form id="Form1" runat="server">
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server"  Width="100%" Height="2100px"
